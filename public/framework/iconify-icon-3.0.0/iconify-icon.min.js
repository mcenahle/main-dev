...
!(function () {
  ...
  const u = /^[a-z0-9]+(-[a-z0-9]+)*$/,
    ...
    f = (t, e) => !!t && !(!((e && "" === t.prefix) || t.prefix) || !t.name);
  function d(t, n) {
  ...
  function v(t) {
    ...
    for (const t in n) {
      const e = n[t];
      if (!t || "string" != typeof e.body || !b(e, i)) return null;
    }
    const r = e.aliases || Object.create(null);
    for (const t in r) {
      const e = r[t],
        o = e.parent;
      if (!t || "string" != typeof o || (!n[o] && !r[o]) || !b(e, i))
        return null;
    }
    return e;
  }
  ...
  function A(t) {
    const e = "string" == typeof t ? l(t, !0, w) : t;
    if (e) {
  ...
  function O(t, e) {
    ...
    if (
      ("string" != typeof e && (e = t.provider || ""), w && !e && !t.prefix)
    ) {
      let e = !1;
      return (
        v(t) &&
    ...
    if ("string" == typeof t) {
      ...
      const o = (function (t) {
        if (!$[t]) {
          const e = D(t);
          if (!e) return;
          const n = { config: e, redundancy: M(e) };
          $[t] = n;
        }
        return $[t];
      })(t);
      ...
      if (e) {
        i = M(e);
        const n = S(t.resources ? t.resources[0] : "");
        n && (r = n.send);
      }
    }
              ...
              setTimeout(() => {
                ...
                e.forEach((e) => {
                  ...
                  ((o.pending = o.pending.filter((e) => {
                    ...
                    const s = e.name;
                    if (t.icons[s])
                      o.loaded.push({ provider: i, prefix: r, name: s });
                    else {
      ...
      t.iconsQueueFlag ||
        ...
        setTimeout(() => {
          ...
          if (t.loadIcons && (i.length > 1 || !r))
            return void W(t.loadIcons(i, n, e), (e) => {
              K(t, i, e);
            });
          if (r)
            return void i.forEach((i) => {
              W(r(i, n, e), (e) => {
                K(t, [i], e ? { prefix: n, icons: { [i]: e } } : null);
              });
            });
          const { valid: o, invalid: s } = (function (t) {
            const e = [],
              n = [];
            return (
              t.forEach((t) => {
                (t.match(u) ? e : n).push(t);
              }),
              { valid: e, invalid: n }
            );
          })(i);
          if ((s.length && K(t, s, null), !o.length)) return;
          const c = n.match(u) ? S(e) : null;
          if (!c) return void K(t, o, null);
          c.prepare(e, n, o).forEach((n) => {
            B(e, n, (e) => {
              K(t, n.icons, e);
            });
          });
  ...
  const Y = (t, e) => {
      ...
      if (!i.pending.length) {
        ...
        return (
          e &&
            setTimeout(() => {
              t && e(i.loaded, i.missing, i.pending, G);
            }),
          () => {
            t = !1;
          }
  ...
  let et = !1;
  try {
    et = 0 === navigator.vendor.indexOf("Apple");
  } catch (t) {}
  const nt = /(-?[0-9.]*[0-9]+[0-9.]*)/g,
    it = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
  function rt(t, e, n) {
    if (1 === e) return t;
  ...
  const ot = (t) => "unset" === t || "undefined" === t || "none" === t;
  function st(t, e) {
    const i = { ...n, ...t },
      r = { ...o, ...e },
    ...
    let d, h;
    null === a
      ? ((h = null === u ? "1em" : "auto" === u ? f : u), (d = rt(h, l / f)))
      : ((d = "auto" === a ? l : a),
        (h = null === u ? rt(d, f / l) : "auto" === u ? f : u));
    const p = {},
      g = (t, e) => {
        ot(e) || (p[t] = e.toString());
      };
  ...
  function mt(t, e) {
    let n = Array.from(t.childNodes).find(
      (t) => t.hasAttribute && t.hasAttribute(gt),
    );
    (n ||
      ((n = document.createElement("style")),
      n.setAttribute(gt, gt),
      t.appendChild(n)),
      (n.textContent =
  ...
  const yt = { "background-color": "currentColor" },
    xt = { "background-color": "transparent" },
    _t = { image: "var(--svg)", repeat: "no-repeat", size: "100% 100%" },
    wt = { "-webkit-mask": yt, mask: yt, background: xt };
  for (const t in wt) {
    const e = wt[t];
    for (const n in _t) e[t + "-" + n] = _t[n];
  }
  function kt(t) {
    ...
    if ("svg" === s)
      c = (function (t) {
        ...
        (n.width || (i = "width: inherit;"),
          ...
          i && (n.style = i));
        const r = ct(t.body, n);
        return ((e.innerHTML = jt(r)), e.firstChild);
      })(o);
    else
      c = (function (t, e, n) {
        ...
        const o = t.attributes,
          s = at(ct(r, { ...o, width: e.width + "", height: e.height + "" })),
          c = i.style,
          a = {
            "--svg": s,
            width: kt(o.width),
  ...
  !(function (t = "iconify-icon") {
    ...
    const r = [
      ...
      o = class extends n {
        ...
        constructor() {
          ...
          (mt(t, e), (this._state = It({ value: "" }, e)), this._queueCheck());
        }
        connectedCallback() {
          ...
          switch (t) {
            case "inline": {
              const t = this.hasAttribute("inline"),
                e = this._state;
              t !== e.inline && ((e.inline = t), mt(this._shadowRoot, t));
              break;
            }
            case "noobserver":
        ...
        _iconChanged(t) {
          const e = (function (t, e) {
            if ("object" == typeof t) return { data: tt(t), value: t };
            if ("string" != typeof t) return { value: t };
            if (t.includes("{")) {
              const e = tt(t);
              if (e) return { data: e, value: t };
            }
            const n = l(t, !0, !0);
            if (!n) return { value: t };
            const i = A(n);
          ...
          e.data
            ? this._gotIconData(e)
            : (this._state = It(e, this._state.inline, this._state));
        }
        _forceRender() {
          if (this._visible) this._queueCheck();
          else {
            const t = Ot(this._shadowRoot);
        ...
        _renderIcon(t, e, n) {
          const i = (function (t, e) {
              ...
              return "style" === e || (!et && -1 !== t.indexOf("<a"))
    ...
    const s = (function () {
      ...
      return {
        ...
        loadIcon: Z,
        addAPIProvider: U,
        setCustomIconLoader: pt,
        setCustomIconsLoader: ht,
        appendCustomStyle: vt,
        _api: {
          getAPIConfig: D,
          setAPIModule: R,
          sendAPIQuery: B,
